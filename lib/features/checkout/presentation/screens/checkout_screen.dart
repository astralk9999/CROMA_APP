...
import 'package:croma/features/address/providers/address_provider.dart';
...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final discountAmount = _isDiscountApplied
        ? cartTotal * 0.10
        : 0.0; // 10% discount for demo
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => setState(
                      () => _isAddressStepExpanded = !_isAddressStepExpanded,
                    ),
                    child: Container(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          TextButton(
                            onPressed: () =>
                                setState(() => _isAddressStepExpanded = true),
                            child: const Text(
                              'EDITAR',
                              style: TextStyle(
                                color: Color(0xFF202020),
                              ...
                              ElevatedButton(
                                onPressed: _isDiscountApplied
                                    ...
                                    : () {
                                        ...
                                        } else if (_discountController.text
                                            .trim()
                                            .isNotEmpty) {
                                          ScaffoldMessenger.of(
                                            context,
