...
final bestSellersProvider = AutoDisposeFutureProvider<List<Product>>.internal(
  bestSellers,
...
final viralTrendsProvider = AutoDisposeFutureProvider<List<Product>>.internal(
  viralTrends,
  name: r'viralTrendsProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$viralTrendsHash,
  dependencies: null,
...
final limitedDropsProvider = AutoDisposeFutureProvider<List<Product>>.internal(
  limitedDrops,
  name: r'limitedDropsProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$limitedDropsHash,
  dependencies: null,
